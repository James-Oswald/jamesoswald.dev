...
title = "A Transcription of John McCarthy's Czechoslovakia Visit Letter" 
date = "2024-12-14"
description = "An Annotated Transcription of John McCarthy's 1968 Letter to Les Earnest on His Visit to Czechoslovakia"
math = true
tags = ["Historical", "AI"]
series = []
draft = false
...
## Background
Recently, I was going down the rabbit hole on [John McCarthy](https://en.wikipedia.org/wiki/John_McCarthy_(computer_scientist)), best known to me as the inventor of the [Situation Calculus](https://en.wikipedia.org/wiki/Situation_calculus) but more widely know for the creation the [Lisp family](https://en.wikipedia.org/wiki/Lisp_(programming_language)) of programming languages and his folk designation as one of the "founding fathers" of artificial intelligence. While digging into him, I came across a very interesting letter sent to (and later released by) his coworker at Stanford, [Les Ernest](https://en.wikipedia.org/wiki/Les_Earnest). The letter regards a visit by John McCarthy to Czechoslovakia in the wake of the [Prague Spring](https://en.wikipedia.org/wiki/Prague_Spring) and subsequent [invasion by the Warsaw Pact](https://en.wikipedia.org/wiki/Warsaw_Pact_invasion_of_Czechoslovakia). Ernest considered the letter to reflect a pivotal moment in McCarthy's life, and an insight into a later shift in McCarthy's politics. Regardless of Ernest's thoughts, it serves as an interesting primary account of McCarthy's inner thoughts and the feelings expressed by various Czechoslovak researchers regarding the invasion.  
...
## Provenance and Disclaimer Regarding the Letter
The full text of the letter in McCarthy's original handwriting is available from the Internet Archive [here](http://web.archive.org/web/20230607162119/https://web.stanford.edu/~learnest/jmc/czech.pdf). I am not sure when Ernest released the letter to the public, the Internet Archive shows it being publicly available as early as 2014 on [Ernest's Stanford homepage](http://web.archive.org/web/20141025061526/http://web.stanford.edu/~learnest/). Note that McCarthy explicitly states at the end of the letter  
...
The Institute of Technical Cybernetics in Bratislava is on the whole a non-\[loser\][^4]. Its projects look like they might succeed and could be useful if they did. They are designing a 17-bit computer for process control and possibly time sharing to be built out of Czech TTL. If D. Poole[^8] wants an adventure they would be glad to have help.

Czechoslovak scientific institutions have cut all their contacts with the Russians and other eastern countries that invaded them. They are eager for scientific connections with the West. Petraš even asked if they could get subcontracts to do programming or hardware design. This might be worth thinking about for programming firms or outfits like III[^9] because wages and overhead are low and the cream of talent might be available for skimming. 

The trip to [Tatras](https://en.wikipedia.org/wiki/Tatra_Mountains) took 3 days, one each way driving over very bad roads. Once there the trails and \[woods and rocks\][^10] looked exactly like [Sierras](https://en.wikipedia.org/wiki/Sierra_Nevada). In fact when the trail bent right over a wooden bridge, I half expected to see down [Yosemite falls](https://en.wikipedia.org/wiki/Yosemite_Falls), but the falls were one 20 [?][^11] high. We went on a [telepherique](https://en.wikipedia.org/wiki/Aerial_tramway) to the peak above the clouds, a single span of 1 ½ miles. It is interesting to see the cables disappear above into the clouds. The top was \[nice\], signs in many languages, but \[well\], some of the Russian signs \[removed\].
...
Most prevalent of all, however, were signs in praise of [Dubček](https://en.wikipedia.org/wiki/Alexander_Dub%C4%8Dek) and [Svoboda](https://en.wikipedia.org/wiki/Ludv%C3%ADk_Svoboda), and their pictures were everywhere. So far the Russians have achieved the opposite of their purpose in occupying Czechoslovakia. The people here were their friends but now consider the Russians enemies. At the Inst. Tech Cyb, they preferred to translate sentence by sentence than to have me talk Russian. Gvozdjak[^13], [Ruzena](https://en.wikipedia.org/wiki/Ruzena_Bajcsy)'s boss, took me to dinner in a restaurant with his wife who doesn't speak English. When I offered to speak Russian, he said “not in a public place.” He is dean of the faculty at the university and has to watch his position. He said there would be no trouble in extending Ruzena’s leave.

One of the computer designers there had spent two months in [Novosibirsk](https://en.wikipedia.org/wiki/Novosibirsk) in May-June studying time sharing with [Ershov](https://en.wikipedia.org/wiki/Andrey_Yershov). He told me that two weeks after the invasion he received a phone call from Novosibirsk asking him what was the truth about the invasion. Since the Russian had to call three times, this obviously required some courage. 
...
[Zemanek](https://en.wikipedia.org/wiki/Heinz_Zemanek) at IBM in Vienna is the world’s best host. I gave a lecture on [Zohar](https://en.wikipedia.org/wiki/Zohar_Manna)'s results and did some consulting. They are the best group in computer science in IBM.

When I turned on the radio in my hotel room in Vienna, the first thing I heard was, "Und nun wer haben die West Coste gruppe [Blue Cheer](https://en.wikipedia.org/wiki/Blue_Cheer) mit dir [Summer Time Blues](https://en.wikipedia.org/wiki/Summertime_Blues)."[^14] On the whole it was a very good program with two Blue Cheer pieces, the [Jefferson Airplane](https://en.wikipedia.org/wiki/Jefferson_Airplane) [Greasy Heart](https://www.youtube.com/watch?v=RXliy2JobtQ), some Beatles, [Otis Redding](https://en.wikipedia.org/wiki/Otis_Redding), [Wilson Pickett](https://en.wikipedia.org/wiki/Wilson_Pickett) etc. The third channel of Austrian Radio seems to play on American and British stuff and some of it is quite bad.

Today at 11:50 AM I go on to Moscow. Zemanek gave me a preprint by [C.H. Lindsey](https://en.wikipedia.org/wiki/Charles_H._Lindsey) of Manchester called “Algol 68 with less tears”[^15] which is almost completely comprehensible. It's really quite a good language, and I think I will probably leave Novosibirsk in time to go to the meeting in Munich Dec 16-20 to see if Algol 68 can be \[saved\] from the syntax of its inventor.
...
[^6]: I am unable to figure out who this is.

[^7]: I believed originally this to be Dušan Petraš, although I now find it unlikely, he would have only been 26 at the time. 

[^8]: Dave W. Poole, a member of McCarthy's Stanford AI lab. He appears frequently doing experiments in [their archives](https://web.archive.org/web/20241213235810/https://www.fromthepage.com/paged_search/poole-102249). He was also a tuba player and was a pioneer early computer generated music, more info can be found [here](http://web.archive.org/web/20240728054145/https://muse.jhu.edu/pub/6/oa_monograph/chapter/2175188). A picture of him can be found as #38 [here](http://web.archive.org/web/20241112135533/http://infolab.stanford.edu/pub/voy/museum/pictures/AIlab/list.html). Not to be confused with the more famous AI researcher [David L. Poole](https://dblp.org/pid/p/DavidPoole.html).  

[^9]: Probably referring to [Information International, Inc.](https://en.wikipedia.org/wiki/Information_International,_Inc.)

[^10]: This is almost certainly wrong. I believe its actually probably "worlds" and something. 

[^11]: This unit in the text appears to read "as". Unclear what the actual unit should be. 

[^12]: Transcribing Cyrillic cursive is a bit out of my wheelhouse, particularly when McCarthy himself is kind enough to provide us his translations.

[^13]: I believe this is Ladislav Gvozdjak, as described in the paper ["On the history of computer science, computer engineering, and computer technology development in Slovakia"](https://doi.org/10.1109/85.778981).

[^14]: German, translates to "And now we have the West Coast group Blue Cheer with the Summertime Blues".

[^15]: This paper was later published under the name ["ALGOL 68 with Fewer Tears"](https://doi.org/10.1093/comjnl/15.2.176) in 1972.